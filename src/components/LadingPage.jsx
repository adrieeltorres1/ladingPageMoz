    ...
    return (
        <>
            ...
            <section className="m-5">
                ...
                <div>
                    <img className="w-[350px] rounded-lg mt-4 shadow-md" src="../src/assets/chickenAbout.jpg" alt="" />
                </div>
            </section>
            <img className="w-[100px] m-auto" src="../src/assets/fiveStars.png" alt="" />
            <section className="m-5">
                ...
                <div>
                    <p className="text-justify text-lg">
                        ...
                        qualidade e frescor. <img className="w-[100px] float-right ml-3 mt-2" src="../src/assets/valueRoundedfull.png" alt="" /> Acreditamos que o cuidado começa desde a criação até a entrega, assegurando que cada frango seja criado com responsabilidade e atenção aos detalhes.
                    </p>
            ...
            <section className="flex flex-wrap gap-5 justify-center mt-10">
                <img className="w-[150px] h-[150px] object-cover rounded-lg shadow-lg" src="../src/assets/firstImage.jpg" alt="Imagem 1" />

                <img className="w-[150px] h-[150px] object-cover rounded-lg shadow-lg" src="../src/assets/secondImage.jpg" alt="Imagem 2" />

                <img className="w-[150px] h-[150px] object-cover rounded-lg shadow-lg" src="../src/assets/thirdImage.jpg" alt="Imagem 3" />

                <img className="w-[150px] h-[150px] object-cover rounded-lg shadow-lg" src="../src/assets/fourthImage.jpg" alt="Imagem 4" />
            </section>
